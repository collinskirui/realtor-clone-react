...
export default function Listing() {
    ...
    const [contactLandlord, setContactLanadlord] = useState(false);
  ...
  return (
      ...
      {listing.imgUrl.map((url, index)=>(
        <SwiperSlide key={index}>
            <div className="relative w-full overflow-hidden h-[300px]"
             style={{
                background: `url(${listing.imgUrls [index]})centre no-repeat`,
    ...
    items-center" onClick={()=>{
     ...
     right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-2">
      Link Copied</p>)}
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className=" w-full ">
         ...
         {listing.type === "rent" ? " / month" : ""}  
          ...
          <p className="flex items-center mt-6 mb3 font-semibold">
        ...
        <div className=" w-full h-[200px] lg:h-[400px] z-10 overflow-x-hidden mt-6 md:mt-0 md:ml-2"></div>
